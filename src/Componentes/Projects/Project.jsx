        ...
        <div className='flex flex-col p-0 md:p-8'>
            <div className='flex gap-2 md:gap-4'>
                <div className='bg-gradient-to-tl from-black via-[#181818] to-black h-60 md:h-80 border-[0.05px] border-[#404040] rounded-xl flex flex-col justify-between'>
                    ...
                    <div className='p-1 md:p-4 flex items-center justify-center gap-1 md:gap-4'>
                        <a className='px-2 hover:bg-[#202020] hover:border-[0.5px] border-[#404040] rounded-sm' href="https://github.com/Narendra-Saryam/Iris-Flowers-Detection"><img className='w-6' src={github} alt="" /></a>
                        <a className='px-2 hover:bg-[#202020] hover:border-[0.5px] border-[#404040] rounded-sm' href="https://iris-flowers-detection.netlify.app/"><img className='w-6' src={demo} alt="" /></a>
                    </div>
                </div>
                <div className='bg-gradient-to-tl from-black via-[#181818] to-black h-60 md:h-80 border-[0.05px] border-[#404040] rounded-xl flex flex-col justify-between'>
                    <img className='h-28 md:h-40 w-full rounded-t-xl p-[0.5px]' src={riskClassification} alt="" />
                    ...
                    <div className='p-1 md:p-4 flex items-center justify-center gap-1 md:gap-4'>
                        <a className='px-2 hover:bg-[#202020] hover:border-[0.5px] border-[#404040] rounded-sm' href="https://github.com/Narendra-Saryam/Risk-Classification"><img className='w-6' src={github} alt="" /></a>
                        <a className='px-2 hover:bg-[#202020] hover:border-[0.5px] border-[#404040] rounded-sm' href="https://risk-classification.netlify.app/"><img className='w-6' src={demo} alt="" /></a>
                    </div>
                </div>
            </div>
            <div className='flex gap-2 md:gap-4 mt-2 md:mt-4'>
                <div className='bg-gradient-to-tl from-black via-[#181818] to-black h-60 md:h-80 border-[0.05px] border-[#404040] rounded-xl flex flex-col justify-between'>
                    ...
                    <div className='p-1 md:p-4 flex items-center justify-center gap-1 md:gap-4'>
                        <a className='px-2 hover:bg-[#202020] hover:border-[0.5px] border-[#404040] rounded-sm' href="https://github.com/Narendra-Saryam/Online-Clipboard"><img className='w-6' src={github} alt="" /></a>
                        <a className='px-2 hover:bg-[#202020] hover:border-[0.5px] border-[#404040] rounded-sm' href="https://onlineclipboards.netlify.app/"><img className='w-6' src={demo} alt="" /></a>
                    </div>
                </div>
                <div className='bg-gradient-to-tl from-black via-[#181818] to-black h-60 md:h-80 border-[0.05px] border-[#404040] rounded-xl flex flex-col justify-between'>
                    <img className='h-28 md:h-40 w-full rounded-t-xl p-[0.5px]' src={infoRetrievel} alt="" />
                    ...
                    <div className='p-1 md:p-4 flex items-center justify-center gap-1 md:gap-4'>
                        <a className='px-2 hover:bg-[#202020] hover:border-[0.5px] border-[#404040] rounded-sm' href="https://github.com/Narendra-Saryam/IR-Summarization-Project"><img className='w-6' src={github} alt="" /></a>
                        <a className='px-2 hover:bg-[#202020] hover:border-[0.5px] border-[#404040] rounded-sm' href="https://github.com/Narendra-Saryam/IR-Summarization-Project/blob/main/IR_with_Summarization.ipynb"><img className='w-6' src={demo} alt="" /></a>
                    </div>
                </div>
            </div>
        </div>

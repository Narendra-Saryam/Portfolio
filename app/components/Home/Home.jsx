...
const Home = () => {
  return (
    <div id='Home' className='text-white flex flex-wrap-reverse w-full justify-between items-center p-10 md:p-20'>
        ...
        <div className='p-5'>
          <Image className='h-60 md:h-[34rem] w-auto rounded-2xl bg-gradient-to-tl from-black via-[#181818] border-[0.05px] border-[#404040] hover:border-[2px] shadow-xl mr-10' src="/n1nobg.png" alt="Hero Image" width={544} height={544} priority />
        </div>
    </div>
  )
}
